    ...
    Dropzone = (function(_super) {
        ...
        Dropzone.prototype.defaultOptions = {
            ...
            removedfile: function(file) {
                ...
                //removes the object fom glob urls array
                var response = JSON.parse(file['xhr']['response']);
                var url = response['fileUrl'];
                ...
                var removeUrl = _ref2[0].href;
                //ajax call to remove file from cloud
                $.post(removeUrl,
                    {
            ...
            success: function(file) {
                //adds new file url to the gloabal urls array
                var response = JSON.parse(file['xhr']['response']);
                var url = response['fileUrl'];
                ...
                //
                var _ref2 = file.previewElement.querySelectorAll("[data-dz-remove]");
                _ref2[0].href = "http://www.team-8.tk/account/uploadproperty/delete/" + response['publicId'];
