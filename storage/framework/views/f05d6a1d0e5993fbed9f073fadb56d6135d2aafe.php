...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        <div class="table">
            ...
            <div class="row">
                <div class="cell"><a href="<?php echo e('https://www.team-8.tk/details/'.$properties[$i]->id); ?>"><?php echo e($properties[$i]->title); ?></a></div>
                <div class="cell">₺ <?php echo e($properties[$i]->price); ?></div>
                <div class="cell"><?php echo e($reservations[$i]->id); ?></div>
                <div class="cell"><?php echo e($reservations[$i]->unique_id); ?></div>
                <div class="cell"><?php echo e($reservations[$i]->from); ?></div>
                <div class="cell"><?php echo e($reservations[$i]->to); ?></div>
                <div class="cell"><?php echo e($reservations[$i]->active == 1 ? 'ACTIVE' : 'PASSIVE'); ?></div>
                <div class="cell"><a href="<?php echo e(url('/account/reservations/delete')); ?><?php echo e('?prop_id='.$properties[$i]->id); ?><?php echo e('&reservation_id='.$reservations[$i]->id); ?>">Delete</a></div>
            </div>
            <?php endfor; ?>
        </div>
