...
<?php $__env->startSection('content'); ?>
    ...
    <br><br><br><br><br><br>
    <h1>Your Guest(s) for property number "<?php echo e($reservations[0]->property_id); ?>"</h1>
    <hr>
    <br>
    <div class="container">
        <div class="table">
            ...
            <?php for($i = 0; $i < count($reservations); $i++): ?>
                <div class="row">
                    <div class="cell"><img src="<?php echo e($users[$i]->avatar); ?>"> <?php echo e($users[$i]->fullname); ?></div>
                    <div class="cell"><?php echo e($payments[$i]); ?></div>
