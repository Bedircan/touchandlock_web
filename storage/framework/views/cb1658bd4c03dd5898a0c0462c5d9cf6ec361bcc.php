...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        <div class="table">
            ...
            <div class="row">
                <div class="cell">
                    <?php if($properties[$i]['specs']['img_1'] == null): ?>
                        <img style="width: 50px; height: 50px;" src="../img/default-home.png">
                    <?php else: ?>
                        <img style="width: 50px; height: 50px;" src="<?php echo e($properties[$i]['specs']['img_1']); ?>">
                    <?php endif; ?>
                    <a href="<?php echo e('https://www.team-8.tk/details/'.$properties[$i]->id); ?>"><?php echo e($properties[$i]->title); ?></a>
                </div>
                <div class="cell">₺ <?php echo e($properties[$i]->price); ?></div>
                <div class="cell"><?php echo e($properties[$i]->id); ?></div>
                <div class="cell"><?php echo e($properties[$i]->type); ?></div>
                <div class="cell"><?php echo e($properties[$i]->from_date); ?></div>
                <div class="cell"><?php echo e($properties[$i]->to_date); ?></div>
                <div class="cell"><?php echo e($properties[$i]->active == 1 ? 'ACTIVE' : 'PASSIVE'); ?></div>
                <div class="cell"><a href="<?php echo e(url('/account/properties/delete')); ?><?php echo e('?prop_id='.$properties[$i]->id); ?>">Delete</a></div>
            </div>
            <?php endfor; ?>
        </div>
