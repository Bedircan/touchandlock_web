...
@section('content')
    ...
    <div class="main-container">
        ...
        <form role="form" method="post" id="main-form" action="{{ url('account/addproperty')}}">
        ...
        <div class="row setup-content" id="step-4">
            <div class="col-xs-6 col-md-offset-3">
                <div class="col-md-12">
                    ...
                    <form action="{{ url('account/uploadproperty')}}" method="post" class="dropzone" id="my-awesome-dropzone">
    ...
    <script  type="text/javascript">
        $(function () {
            ...
            $('#submitButton').on('click', function () {
                if(validateForm()){
                    $.ajax({
                        url: "{{ url('account/addproperty')}}",
                        method: "POST",
                        data: {formElements: $('#main-form').serialize(), urls: window.urls},
                        success: function (data) {
                            window.location.href = "{{url('/account/properties')}}";
                        },
