...
@section('content')
    ...
    <br><br><br><br><br><br>
    <h1>Your Guest(s) for property number "{{$reservations[0]->property_id}}"</h1>
    <hr>
    <br>
    <div class="container">
        <div class="table">
            ...
            @for($i = 0; $i < count($reservations); $i++)
                <div class="row">
                    <div class="cell"><img src="{{$users[$i]->avatar}}"> {{$users[$i]->fullname}}</div>
                    <div class="cell">{{$payments[$i]}}</div>
